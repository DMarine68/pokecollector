...
export const getPriceCharting = (id) => api.get(`/cards/${id}/pricecharting`).then(r => r.data)
...
export const createProductBook = (data) => api.post('/products/book', data).then(r => r.data)
export const addProductBookCards = (productId, data) => api.post(`/products/${productId}/book-cards`, data).then(r => r.data)
